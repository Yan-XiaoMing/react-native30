...
import {Platform, StatusBar, View, Text, Image, ScrollView, StyleSheet, TouchableHighlight} from 'react-native'
...
class Weather extends Component {
    ...
    render() {
        const slides = this.state.weather.map((elem, index) => {
            ...
            const dayView = elem.days.map((dayElem, index) => {
                return (
                  <View key={dayElem.key}>
                      ...
                      <View>
                          <Icon name={dayElem.icon} size={25}/>
                      </View>
                      <View>
